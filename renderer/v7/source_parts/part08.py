if not qc['narration']['pass'] or not qc['interior_asset_audit_pass'] or not qc['aspect_ratio_policy']['pass'] or not qc['transitions']['pass'] or not qc['non_rank_media']['pass']: qc['all_pass']=False
