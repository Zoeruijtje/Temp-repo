...
def rank_scene(r,target):
    ...
    if r['interior']:
        # Start the cabin reveal before the rank midpoint. This guarantees at least
        # 1.7 seconds at full interior opacity before the next scene wipe begins.
        change=max(2.0,target*0.46); badge=OVERLAYS/f"rank{r['rank']}_interior_badge.png"
